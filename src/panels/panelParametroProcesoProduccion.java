...
import Clases.ProcesoProduccion;
 ...
 * @author Family
 */
public class panelParametroProcesoProduccion extends javax.swing.JPanel {
    ...
    public panelParametroProcesoProduccion() {
        initComponents();
        //reset();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imgs/icons8_administrative_tools_40px.png"))); // NOI18N

        jLabel2.setFont(new java.awt.Font("Segoe UI", 0, 15)); // NOI18N
        jLabel2.setForeground(new java.awt.Color(255, 255, 255));
        jLabel2.setText("Configuración de Procesos de Producción");
    ...
    private void editarBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_editarBtnActionPerformed
        ...
        if (fila >= 0 && !id.equals("-")) {
            ...
            for (ProcesoProduccion proceso : procesos) {
                if (idint == proceso.getId()) {
                    idTxt.setText(proceso.getId() + "");
                    nombreTxt.setText(proceso.getNombre());
                    if (proceso.getEstado().equalsIgnoreCase("activo")) {
                        activoRb.setSelected(true);
                    } else {
    ...
    private void guardarBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_guardarBtnActionPerformed
        if (validarCamposLlenos() == true) {
            ...
            if (valor == 0) {//nuevo
                ...
                if (repetido == false) {
                    int respuesta = new ProcesoProduccion().newProcesoProduccion(nombre);
                    if (respuesta > 0) {
                        new rojerusan.RSNotifyFade("¡¡Agregado!! ", "Proceso agregado con exito!", 4, RSNotifyFade.PositionNotify.BottomRight, RSNotifyFade.TypeNotify.SUCCESS).setVisible(true);
                        limpiarCampos();
                ...
                int respuesta = new ProcesoProduccion().updateProcesoProduccion(id, nombre, estado);
                if (respuesta > 0) {
                    new rojerusan.RSNotifyFade("¡¡Actualizado!! ", "Proceso actualizado con exito!", 4, RSNotifyFade.PositionNotify.BottomRight, RSNotifyFade.TypeNotify.SUCCESS).setVisible(true);
                    limpiarCampos();
                    buscarValorTabla(nombre);
                } else {
...
public void llenarTelas() {
        ...
        procesos.clear();
        procesos = (ArrayList) new ProcesoProduccion().Listar("").clone();
        for (ProcesoProduccion tela : procesos) {
            modelo.addRow(new Object[]{
                tela.getId(), tela.getNombre(), tela.getEstado()
            });
        }
        if (procesos.size() < 1) {
            modelo.addRow(new Object[]{
    ...
    public void llenarProcesos(String estadox) {
        DefaultTableModel modelo = (DefaultTableModel) tabla.getModel();
        modelo.setRowCount(0);
        procesos.clear();
        procesos = (ArrayList) new ProcesoProduccion().Listar(estadox).clone();
        for (ProcesoProduccion proceso : procesos) {
            modelo.addRow(new Object[]{
                proceso.getId(), proceso.getNombre(), proceso.getEstado()
            });
        }
        if (procesos.size() < 1) {
            modelo.addRow(new Object[]{
