 ...
 * @author Family
 */
public class panelParametroTallas extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imgs/icons8_resize_30px.png"))); // NOI18N

        jLabel2.setFont(new java.awt.Font("Segoe UI", 0, 15)); // NOI18N
        jLabel2.setForeground(new java.awt.Color(255, 255, 255));
        jLabel2.setText("Configuración de Tallas");
    ...
    private void editarBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_editarBtnActionPerformed
        ...
        if (fila >= 0 && !id.equals("-")) {
            ...
            for (Talla talla:  tallas) {
                if (idint == talla.getId()) {
                    idTxt.setText(talla.getId() + "");
                    nombreTxt.setText(talla.getNombre());
                    if (talla.getEstado().equalsIgnoreCase("activo")) {
                        activoRb.setSelected(true);
                    } else {
    ...
    private void guardarBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_guardarBtnActionPerformed
        if (validarCamposLlenos() == true) {
            ...
            if (valor == 0) {//nuevo
                ...
                for (Talla talla:  tallas) {
                    if (talla.getNombre().equalsIgnoreCase(nombre)) {
                        repetido = true;
                    }
                }
                if (repetido == false) {
                    int respuesta = new Talla().newTalla(nombre);
                    if (respuesta > 0) {
                ...
                int respuesta = new Talla().updateTalla(id, nombre, estado);
                if (respuesta > 0) {
    ...
    public void llenarTallas(String estadox) {
        DefaultTableModel modelo = (DefaultTableModel) tabla.getModel();
        modelo.setRowCount(0);
        tallas.clear();
        tallas = (ArrayList) new Talla().Listar(estadox).clone();
        for (Talla talla : tallas) {
            modelo.addRow(new Object[]{
                talla.getId(), talla.getNombre(), talla.getEstado()
            });
        }
        if (tallas.size() < 1) {
            modelo.addRow(new Object[]{
