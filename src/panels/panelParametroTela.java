 ...
 * @author Family
 */
public class panelParametroTela extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imgs/icons8_vegan_clothing_32px.png"))); // NOI18N

        jLabel2.setFont(new java.awt.Font("Segoe UI", 0, 15)); // NOI18N
        jLabel2.setForeground(new java.awt.Color(255, 255, 255));
        jLabel2.setText("Configuración de Tela");
    ...
    private void editarBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_editarBtnActionPerformed
        ...
        if (fila >= 0 && !id.equals("-")) {
            ...
            for (Tela tela : telas) {
                if (idint == tela.getId()) {
                    idTxt.setText(tela.getId() + "");
                    nombreTxt.setText(tela.getNombre());
                    if (tela.getEstado().equalsIgnoreCase("activo")) {
                        activoRb.setSelected(true);
                    } else {
    ...
    private void guardarBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_guardarBtnActionPerformed
        if (validarCamposLlenos() == true) {
            ...
            if (valor == 0) {//nuevo
                ...
                for (Tela tela : telas) {
                    if (tela.getNombre().equalsIgnoreCase(nombre)) {
                        repetido = true;
                    }
                }
                if (repetido == false) {
                    int respuesta = new Tela().newTela(nombre);
                    if (respuesta > 0) {
                ...
                int respuesta = new Tela().updateTela(id, nombre, estado);
                if (respuesta > 0) {
...
public void llenarTelas() {
        ...
        telas.clear();
        telas = (ArrayList) new Tela().Listar("").clone();
        for (Tela tela : telas) {
    ...
    public void llenarTelas(String estadox) {
        DefaultTableModel modelo = (DefaultTableModel) tabla.getModel();
        modelo.setRowCount(0);
        telas.clear();
        telas = (ArrayList) new Tela().Listar(estadox).clone();
        for (Tela tela : telas) {
            modelo.addRow(new Object[]{
                tela.getId(), tela.getNombre(), tela.getEstado()
            });
