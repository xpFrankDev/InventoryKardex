 ...
 * @author Family
 */
public class panelParametroTipoUnidad extends javax.swing.JPanel {

    ArrayList<TipoUnidad> unidades = new ArrayList();
    int valor = -1;
    String estado = "Activo";
    public boolean agregar=false;
    public boolean editar=false;
    public panelParametroTipoUnidad() {
        initComponents();
        //reset();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imgs/icons8_weight_kg_32px.png"))); // NOI18N

        jLabel2.setFont(new java.awt.Font("Segoe UI", 0, 15)); // NOI18N
        jLabel2.setForeground(new java.awt.Color(255, 255, 255));
        jLabel2.setText("Configuración de Tipo de Unidades");
    ...
    private void editarBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_editarBtnActionPerformed
        ...
        if (fila >= 0 && !id.equals("-")) {
            ...
            for (TipoUnidad unidad:  unidades) {
                if (idint == unidad.getId()) {
                    idTxt.setText(unidad.getId() + "");
                    nombreTxt.setText(unidad.getNombre());
                    if (unidad.getEstado().equalsIgnoreCase("activo")) {
                        activoRb.setSelected(true);
                    } else {
    ...
    private void guardarBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_guardarBtnActionPerformed
        if (validarCamposLlenos() == true) {
            ...
            if (valor == 0) {//nuevo
                ...
                if (repetido == false) {
                    int respuesta = new TipoUnidad().newTipoUnidad(nombre);
                    if (respuesta > 0) {
                        new rojerusan.RSNotifyFade("¡¡Agregado!! ", "Talla agregado con exito!", 4, RSNotifyFade.PositionNotify.BottomRight, RSNotifyFade.TypeNotify.SUCCESS).setVisible(true);
                        limpiarCampos();
                    ...
                    new rojerusan.RSNotifyFade("¡¡Valor Repetido!! ", "Los valores deben ser únicos, intente con otro valor y vuelva intentarlo!", 4, RSNotifyFade.PositionNotify.BottomRight, RSNotifyFade.TypeNotify.INFORMATION).setVisible(true);

                }

            } else if (valor == 1) {//editar
                int id = Integer.valueOf(idTxt.getText());
                int respuesta = new TipoUnidad().updateTipoUnidad(id, nombre, estado);
                if (respuesta > 0) {
                    new rojerusan.RSNotifyFade("¡¡Actualizado!! ", "Talla actualizado con exito!", 4, RSNotifyFade.PositionNotify.BottomRight, RSNotifyFade.TypeNotify.SUCCESS).setVisible(true);
                    limpiarCampos();
                    buscarValorTabla(nombre);
                } else {
    ...
    public void llenarUnidades(String estadox) {
        DefaultTableModel modelo = (DefaultTableModel) tabla.getModel();
        modelo.setRowCount(0);
        unidades.clear();
        unidades = (ArrayList) new TipoUnidad().Listar(estadox).clone();
        for (TipoUnidad unidad : unidades) {
            modelo.addRow(new Object[]{
                unidad.getId(), unidad.getNombre(), unidad.getEstado()
            });
        }
        if (unidades.size() < 1) {
            modelo.addRow(new Object[]{
