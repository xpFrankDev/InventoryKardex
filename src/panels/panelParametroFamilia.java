 ...
 * @author Family
 */
public class panelParametroFamilia extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imgs/icons8_family_32px.png"))); // NOI18N

        jLabel2.setFont(new java.awt.Font("Segoe UI", 0, 15)); // NOI18N
        jLabel2.setForeground(new java.awt.Color(255, 255, 255));
        jLabel2.setText("Configuración de Familia(s)");
    ...
    private void editarBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_editarBtnActionPerformed
        ...
        if (fila >= 0 && !id.equals("-")) {
            ...
            for (Familia familia : familias) {
                if (idint == familia.getId()) {
                    idTxt.setText(familia.getId() + "");
                    nombreTxt.setText(familia.getNombre());
                    if (familia.getEstado().equalsIgnoreCase("activo")) {
                        activoRb.setSelected(true);
                    } else {
    ...
    private void guardarBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_guardarBtnActionPerformed
        if (validarCamposLlenos() == true) {
            ...
            if (valor == 0) {//nuevo
                ...
                for (Familia familia : familias) {
                    if (familia.getNombre().equalsIgnoreCase(nombre)) {
                        repetido = true;
                    }
                }
                if (repetido == false) {
                    int respuesta = new Familia().newFamilia(nombre);
                    if (respuesta > 0) {
                ...
                int respuesta = new Familia().updateFamilia(id, nombre, estado);
                if (respuesta > 0) {
    ...
    public  void llenarFamilia(String estadox) {
        DefaultTableModel modelo = (DefaultTableModel) tabla.getModel();
        modelo.setRowCount(0);
        familias.clear();
        familias = (ArrayList) new Familia().Listar(estadox).clone();
        for (Familia familia : familias) {
            modelo.addRow(new Object[]{
                familia.getId(), familia.getNombre(), familia.getEstado()
            });
        }
        if (familias.size() < 1) {
            modelo.addRow(new Object[]{
